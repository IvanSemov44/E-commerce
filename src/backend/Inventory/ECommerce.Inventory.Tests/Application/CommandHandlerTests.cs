...
public class CommandHandlerTests
{
    ...
    [TestMethod]
    public async Task IncreaseStock_ExistingItem_IncreasesQuantity()
    {
    ...
    [TestMethod]
    public async Task ReduceStock_ExistingItem_ReducesQuantity()
    {
        var productId = Guid.NewGuid();
        var repo = new FakeInventoryItemRepository();
    ...
    [TestMethod]
    public async Task ReduceStock_InsufficientStock_ReturnsFailure()
    {
        var productId = Guid.NewGuid();
        var repo = new FakeInventoryItemRepository();
    ...
    [TestMethod]
    public async Task AdjustStock_NegativeQuantity_ReturnsFailure()
    {
        var productId = Guid.NewGuid();
        var repo = new FakeInventoryItemRepository();
        var projectionPublisher = new FakeInventoryProjectionEventPublisher();
