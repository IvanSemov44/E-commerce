...
/// <summary>
/// In-memory fake for IPromoCodeRepository used in integration tests.
/// Mirrors the implementation in ECommerce.Promotions.Tests to avoid a cross-project reference.
/// </summary>
