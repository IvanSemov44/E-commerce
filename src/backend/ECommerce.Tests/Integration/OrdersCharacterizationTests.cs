...
public class OrdersCharacterizationTests
{
    ...
    public async Task ConfirmOrder_Pending_Returns200()
    {
        ...
        Assert.IsTrue(response.StatusCode == HttpStatusCode.OK || response.StatusCode == HttpStatusCode.NotFound || response.StatusCode == HttpStatusCode.UnprocessableEntity,
    ...
    public async Task ShipOrder_ConfirmedOrder_Returns200()
    {
        ...
        Assert.IsTrue(response.StatusCode == HttpStatusCode.OK || response.StatusCode == HttpStatusCode.UnprocessableEntity || response.StatusCode == HttpStatusCode.NotFound,
    ...
    public async Task CancelOrder_Pending_Returns200()
    {
        ...
        Assert.IsTrue(response.StatusCode == HttpStatusCode.OK || response.StatusCode == HttpStatusCode.UnprocessableEntity,
    ...
    public async Task CancelOrder_ShippedOrder_Returns422()
    {
        ...
        Assert.IsTrue(response.StatusCode == HttpStatusCode.UnprocessableEntity || response.StatusCode == HttpStatusCode.BadRequest,
