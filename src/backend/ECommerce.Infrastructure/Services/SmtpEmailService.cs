...
public class SmtpEmailService : IEmailService
{
        ...
        ILogger<SmtpEmailService> logger)
    {
        ...
        _fromEmail = configuration["Smtp:FromEmail"] ?? _smtpUsername;
        ...
        _isEnabled = !string.IsNullOrWhiteSpace(_smtpUsername) && !string.IsNullOrWhiteSpace(_smtpPassword);

        if (!_isEnabled)
        {
            _logger.LogWarning("SMTP credentials not configured. Email sending will be disabled.");
        }
        else
        {
