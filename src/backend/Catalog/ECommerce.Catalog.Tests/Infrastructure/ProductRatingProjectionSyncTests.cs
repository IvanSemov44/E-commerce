...
namespace ECommerce.Catalog.Tests.Infrastructure;

[TestClass]
public class ProductRatingProjectionSyncTests
{
    [TestMethod]
    ...
    public async Task PublishRating_WhenProjectionExists_UpdatesProjection()
    {
        ...
        {
            ProductId = productId, AverageRating = 2.0m, ReviewCount = 1, UpdatedAt = DateTime.UtcNow.AddDays(-1)
        });
