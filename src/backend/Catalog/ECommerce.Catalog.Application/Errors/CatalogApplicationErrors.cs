...
public static class CatalogApplicationErrors
{
    ...
    public static readonly DomainError DuplicateProductSlug = new("DUPLICATE_PRODUCT_SLUG", "A product with this slug already exists.");
    public static readonly DomainError DuplicateCategorySlug = new("DUPLICATE_CATEGORY_SLUG", "A category with this slug already exists.");
