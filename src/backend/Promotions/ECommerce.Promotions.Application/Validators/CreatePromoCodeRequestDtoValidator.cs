...
public class CreatePromoCodeRequestDtoValidator : AbstractValidator<CreatePromoCodeRequestDto>
{
    public CreatePromoCodeRequestDtoValidator()
    {
        RuleFor(x => x.Code)
        ...
        RuleFor(x => x.DiscountType)
            ...
            .Must(x => x == "Percentage" || x == "Fixed").WithMessage("Discount type must be 'Percentage' or 'Fixed'");
