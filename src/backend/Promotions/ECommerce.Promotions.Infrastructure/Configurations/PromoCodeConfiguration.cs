...
public class PromoCodeConfiguration : IEntityTypeConfiguration<PromoCode>
{
    public void Configure(EntityTypeBuilder<PromoCode> builder)
    {
        ...
        {
            vb.Property(v => v.Start).HasColumnName("StartDate");
            vb.Property(v => v.End).HasColumnName("EndDate");
        });

        builder.Property(p => p.MaxUses).HasColumnName("MaxUses");
        builder.Property(p => p.UsedCount).HasColumnName("UsedCount").IsRequired();
        builder.Property(p => p.IsActive).HasColumnName("IsActive").IsRequired();
        builder.Property(p => p.MinimumOrderAmount).HasColumnName("MinOrderAmount").HasPrecision(18, 2);
        builder.Property(p => p.MaxDiscountAmount).HasColumnName("MaxDiscountAmount").HasPrecision(18, 2);
