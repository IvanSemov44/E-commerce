...
/// <summary>
/// Executes integration event handling with inbox-based deduplication against the ordering schema.
/// </summary>
public sealed class InboxIdempotencyProcessor(OrderingDbContext dbContext) : IInboxProcessor
{
