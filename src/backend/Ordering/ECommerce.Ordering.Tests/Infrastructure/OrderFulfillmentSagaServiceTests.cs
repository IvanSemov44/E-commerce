...
public class OrderFulfillmentSagaServiceTests
{
    ...
    public async Task StartThenReserved_MarksSagaCompleted()
    {
        ...
        await service.StartAsync(new OrderPlacedIntegrationEvent(orderId, Guid.NewGuid(), [Guid.NewGuid()], 120m)
        {
    ...
    internal sealed class TestOrderCompensationService : IOrderCompensationService
    {
