  ...
  useTranslation: () => ({
    t: (key: string, params?: any) => {
      const translations: Record<string, string | ((p: any) => string)> = {
        ...
        'common.viewAllResults': (p: any) => `View all results for "${p.query}"`,
      }
...
// Mock products API
const mockProducts = [
  { id: '1', name: 'Wireless Headphones', slug: 'wireless-headphones', price: 99.99, compareAtPrice: 129.99, images: [{ url: 'https://example.com/img1.jpg' }] },
  { id: '2', name: 'Wireless Mouse', slug: 'wireless-mouse', price: 49.99, compareAtPrice: null, images: [] },
]
