...
describe('ProfileMessages', () => {
  it('renders nothing when no messages provided', () => {
    const { container } = render(<ProfileMessages />);

    expect(container.firstChild).toBeNull();
  });

  it('renders success message when provided', () => {
    render(<ProfileMessages successMessage="Profile updated successfully" />);

    expect(screen.getByText('Profile updated successfully')).toBeInTheDocument();
  });

  it('renders error message when provided', () => {
    render(<ProfileMessages errorMessage="Failed to update profile" />);
  ...
  it('renders both messages when both provided', () => {
    render(
      <ProfileMessages successMessage="Profile updated" errorMessage="But some fields failed" />
    );
  ...
  it('renders in container with proper structure', () => {
    const { container } = render(<ProfileMessages successMessage="Profile updated" />);
