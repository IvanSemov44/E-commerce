...
describe('OrderSuccess', () => {
  ...
  it('renders action links to orders and products', () => {
    ...
    expect(screen.getByRole('link', { name: /orderSuccess\.viewOrders/i })).toHaveAttribute('href', '/orders');
    expect(screen.getByRole('link', { name: /orderSuccess\.continueShopping/i })).toHaveAttribute('href', '/products');
  });
