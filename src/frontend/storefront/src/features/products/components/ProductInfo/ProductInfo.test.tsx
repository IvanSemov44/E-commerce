...
describe('ProductInfo', () => {
  ...
  it('should render product name', () => {
    ...
    expect(screen.getByRole('heading', { level: 1 })).toHaveTextContent('Premium Wireless Headphones')
  })
  ...
  it('should not show compare-at price when not provided', () => {
    const { compareAtPrice, ...propsWithoutCompare } = defaultProps
  ...
  it('should not render description when undefined', () => {
    ...
    expect(screen.queryByText('High-quality audio with noise cancellation')).not.toBeInTheDocument()
  })
