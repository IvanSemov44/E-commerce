      ...
      <Card variant="elevated" padding="lg" className={styles.card}>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            or on behalf of an entity ("you") and our e-commerce platform ("Company," "we," "us," or "our"), 
            concerning your access to and use of our website as well as any other media form, media channel, 
          ...
          <p>
            ...
            of these Terms of Service. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF SERVICE, THEN YOU ARE 
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            in immediate termination of your account on our Site.
          </p>
          <p>You are responsible for safeguarding the password that you use to access the Site and for any activities or actions under your password.</p>
          <p>We may suspend or terminate your account at any time for any reason at our sole discretion.</p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            We offer various shipping options which will be presented to you during the checkout process. 
            Delivery times are estimates and are not guaranteed. We are not responsible for delays caused 
            by shipping carriers or customs processing.
          </p>
          <p>
            Risk of loss and title for items purchased from this Site pass to you upon delivery of the items 
        ...
        <section className={styles.section}>
          ...
          <p>
            Our return policy allows returns within 30 days of purchase. Items must be unused, in original 
            packaging, and accompanied by proof of purchase. For full details, please see our 
        ...
        <section className={styles.section}>
          ...
          <p>
            The Site and its original content, features and functionality are and will remain the exclusive 
            property of the Company and its licensors. The Site is protected by copyright, trademark, and 
            other laws of both the Company and foreign countries.
          </p>
          <p>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>Attempting to gain unauthorized access to any part of the Site or any systems or networks connected to the Site</li>
            <li>Interfering with or disrupting the Site or servers or networks connected to the Site</li>
            <li>Collecting or harvesting any information or data from the Site without our consent</li>
          </ul>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            the Company is registered. The Company's ability to seek injunctive or other equitable relief 
            in any court of competent jurisdiction is not affected by this provision.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            of Service at any time and for any reason. We will alert you about any changes by updating the 
