      ...
      <Card variant="elevated" padding="lg" className={styles.card}>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            You can pay with credit card, PayPal, or other available payment methods.
          </p>
          ...
          <p>
            Yes, we use industry-standard SSL encryption and never store your full credit 
            card details. All payments are processed through secure, PCI-compliant payment processors.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            Standard shipping typically takes 5-7 business days. Express shipping is available 
            for 2-3 business day delivery. International shipping times vary by destination.
          </p>
          ...
          <p>
            ...
            track your order in the "Order History" section of your account.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            original packaging. See our <Link to="/returns" className={styles.link}>Returns Policy</Link> for full details.
          </p>
          
          <h3>How do I request a refund?</h3>
          <p>
            Contact our customer support team or initiate a return through your account. 
