    ...
    <div className={styles.container}>
      <Card variant="elevated" padding="lg" className={styles.card}>
        ...
        <section className={styles.section}>
          ...
          <p>
            Welcome to our e-commerce platform. We respect your privacy and are committed to protecting 
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li><strong>Contact Data:</strong> Email address, telephone numbers, billing and shipping addresses</li>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            we use them, please see our <Link to="/cookies" className={styles.link}>Cookie Policy</Link>.
          </p>
        </section>
