    ...
    <div className={styles.container}>
      <Card variant="elevated" padding="lg" className={styles.card}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            <li><strong>Essential Cookies:</strong> Required for the website to function properly (authentication, shopping cart, checkout)</li>
        ...
        <section className={styles.section}>
          ...
          <p>
            These are temporary cookies that are deleted when you close your browser. They 
            are used to maintain your session during a single visit.
          </p>
          
          <h3>Persistent Cookies</h3>
          <p>
            These remain on your device for a set period or until you delete them. They 
            remember your preferences for future visits.
          </p>
          
          <h3>Third-Party Cookies</h3>
          <p>
            Set by third-party services we use (analytics, payment processors, social media). 
            These are subject to those third parties' privacy policies.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            Most browsers allow you to manage cookie settings. Here's how to access these 
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            <br /><br />
            Email: privacy@ecommerce.com<br />
