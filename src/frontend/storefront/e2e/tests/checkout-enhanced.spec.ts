  ...
  test.describe('Place Order', () => {
    ...
    test('should show order confirmation with order number', async ({ page }) => {
      ...
      const orderNumber = page
        ...
        .or(page.locator('[class*="order-number"], :text(/ORD-|Order #/)'));
    ...
    test('should show estimated delivery date', async ({ page }) => {
      ...
      const deliveryDate = page
        .getByTestId('delivery-date')
        .or(page.locator(':text("Delivery"), :text("Arrives")'));
  ...
  test.describe('Guest Checkout', () => {
    ...
    test('should offer login option during guest checkout', async ({ page }) => {
      const loginLink = page
        ...
        .or(page.locator('a:has-text("Login"), a:has-text("Sign in")'));
