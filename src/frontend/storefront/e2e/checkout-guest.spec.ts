...
test.describe('Guest Checkout', () => {
  ...
  test('should require email for guest checkout', async ({ page }) => {
    ...
    const submitButton = page
      .locator('button[type="submit"], button:has-text("Place Order"), button:has-text("Complete")')
      .first();
  ...
  test('should show order summary with items and totals', async ({ page }) => {
    ...
    const subtotal = page.locator('[data-testid="subtotal"], .subtotal, :has-text("Subtotal")');

    const total = page.locator('[data-testid="total"], .total, :has-text("Total")');
  ...
  test('should fill guest checkout form successfully', async ({ page }) => {
    ...
    const addressInput = page
      .locator('input[name*="address"], input[placeholder*="Address"]')
      .first();
